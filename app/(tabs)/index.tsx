...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#1B98E0', alignItems: 'center', justifyContent: 'center' },
  imageContainer: { flex: 1, paddingTop: 58, width: '100%', alignItems: 'center' },
  footerContainer: { flex: 1 / 3, alignItems: 'center', justifyContent: 'center' },
  optionsContainer: { position: 'absolute', bottom: 80, left: 0, right: 0, alignItems: 'center' },
